...
namespace Responsible.Handler.Winforms
{
    ...
    public static class Handler
    {
        ...
        [Obsolete("Handler.HandleResponse is deprecated, please use ResponsibleMessage.HandleResponse", false)]
        ...
        {
            ResponsibleMessage.HandleResponse(operationTitle, response, showSuccessMessage, ignoreResponseMessage, successMessage);
        }
    }
}
